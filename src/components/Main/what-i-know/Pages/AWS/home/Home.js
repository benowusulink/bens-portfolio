...
const AWSHome = ({onRouteChange}) =>{
	...
	return(
		...
		<article onClick={()=>{onRouteChange("Compute")}}>
		<img src="" alt={`Compute`}/>
		<h3> Compute </h3>
		</article>
		<article onClick={()=>{onRouteChange("Network")}} >
		<img src="" alt={`Network, Content and Delivery`}/>
		<h3> network content and delivery </h3>
		</article>
		</section>
		<section className ={`aws-section-2`}>
		<article onClick={()=>{onRouteChange("Security")}}>
		<img src="" alt={`Secrurity`}/>
		<h3> Secrurity, identity and compliance </h3>
		</article>
		<article onClick={()=>{onRouteChange("Storage")}}>
		<img src="" alt={`storage`}/>
		<h3> storage </h3>
		</article>
		<article onClick={()=>{onRouteChange("Databases")}}>
